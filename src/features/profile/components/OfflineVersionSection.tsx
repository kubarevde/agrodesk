      ...
      <div className="space-y-2 text-sm text-muted-foreground">
        ...
        <ol className="list-decimal space-y-1.5 pl-5">
          ...
          <li>
            ...
            <span className="font-medium text-foreground">с интернетом</span> под своим логином —
            подтянутся списки и сохранится ваш профиль (не чужой кэш).
          </li>
          <li>
            Без сети: открытие и закрытие смены (очередь в шапке). Руководителю — просмотр
            кэшированных смен/справочников. Склад: операции из кэша очереди; отчёты и поддержка —
            только онлайн.
          </li>
        </ol>
      </div>
