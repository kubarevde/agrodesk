...
export const TERM_DEFS: Record<string, TermDef> = {
  ...
  tmc: {
    label: 'ТМЦ',
    meaning: 'Товарно-материальные ценности: топливо, запчасти, семена, расходники; опционально урожай как товар на складе (категория «Урожай»).',
...
export const SECTION_SUMMARIES: Record<string, string> = {
  ...
  'agro-calendar': 'План работ по полям и датам. Метка «Погодное предупреждение» — риск по прогнозу.',
  tasks:
    'Текущие хозяйственные и административные поручения. Не путать с агрокалендарём и сменами.',
  sharing: 'Объявления между хозяйствами платформы: поле, техника, приспособления. Архив — в «Мои объявления».',
  ...
  inventory: 'Склад: остатки топлива, запчастей и урожая как товара; приход, расход, сбор с поля.',
  shipments: 'Учёт продаж урожая и отгрузок ТМЦ по заявкам со склада.',
  expenses: 'Деньги хозяйства: затраты и связанные доходы в учёте.',
  analytics: 'Вкладка «Факт и прогноз» в «Затраты и доходы»: прогноз по прошлым отгрузкам и затратам.',
  reports: 'Скачать отчёты в Excel.',
  employees: 'Люди в хозяйстве, роли и ставки оплаты.',
  'audit-log': 'Кто что менял в системе.',
  settings: 'Справочники хозяйства, часовой пояс и доступы к разделам.',
  'my-shift': 'Ваша смена: начать, закончить, посмотреть начисления.',
  workspace: 'Смена, задачи, заявки ТМЦ и сообщения в одном месте.',
