...
export const SECTION_SUMMARIES: Record<string, string> = {
  ...
  inventory: 'Склад ТМЦ: остатки, приход/расход; урожай как товар (категория «Урожай») и сбор с поля.',
  shipments: 'Учёт отгрузок урожая (культуры, кг, KPI). Можно связать с выполненной harvest‑заявкой.',
