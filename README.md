...
|--------|--------|----------|
| Смены / моя смена | Реализовано | [offline.md](docs/offline.md) (офлайн-запись) |
| Склад / ТМЦ | Реализовано | — |
| Заявки на отгрузку | Реализовано | [shipment-requests.md](docs/shipment-requests.md) |
| Отгрузки урожая | Реализовано | [shipments.md](docs/shipments.md) |
