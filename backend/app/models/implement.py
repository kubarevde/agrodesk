...
class Implement(Base):
    ...
    current_usage_hours = Column(Numeric(10, 2), nullable=False, default=0, server_default='0')
    service_interval_hours = Column(Numeric(10, 2), nullable=True)
    next_service_hours = Column(Numeric(10, 2), nullable=True)
